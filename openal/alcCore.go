...
func (self *CaptureDevice) CaptureToInt16Pointer(data unsafe.Pointer, sampleCount int) {
	C.alcCaptureSamples(unsafe.Pointer(self.handle), data, C.ALCsizei(uint32(sampleCount)*2/self.sampleSize))
}
