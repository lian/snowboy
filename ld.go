...
#cgo linux,amd64 LDFLAGS: -lcblas -L${SRCDIR} -Wl,-Bstatic -lsnowboy-detect-ubuntu64 -Wl,-Bdynamic
#cgo linux,arm LDFLAGS: -lcblas -L${SRCDIR} -Wl,-Bstatic -lsnowboy-detect-rpi -Wl,-Bdynamic
